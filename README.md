...
4)    Message Masking:
        * A percentage of the total of characters at that point is added to the encoded message to mask the real encoded message to make its analysis more difficult.
